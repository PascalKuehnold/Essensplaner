...
class SimpleEntityReadWriteTest {
    ...
    @Throws(Exception::class)
     fun writeUserAndReadInList() {
        for(i in 1..100) {
            val gericht = Gericht(0, "Gericht $i", "Zutat $i", true, schnellesGericht = false, gerichtAuthor = "", mehrereTage = false, isChefkochGericht = false, gesamtKochzeit = "", gerichtRezept = "")
